...
import com.igqapp.zendapp.Adapter.UsuarioAdapter;
...
public class usuariosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //BOTON SETTING
        ImageView settings = view.findViewById(R.id.ic_settings);
        ...
        adapter = new UsuarioAdapter(usuarioArrayList,getContext());
